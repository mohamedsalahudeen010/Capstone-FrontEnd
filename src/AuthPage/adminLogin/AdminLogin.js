...
const AdminLogInPage = ({admin,setAdmin}) => {
  ...
  const logInFunc = async (email) => {
    try {
      const response = await fetch("https://capstone-back-end-flame.vercel.app/adminLogIn", {
        method: "POST",
  ...
  return (
    ...
    <div className="loginPage-admin">
      ...
      <div className="main-logo-admin">
        ...
        <div>
          <h3 className="title-signIn-admin">
            Indian Gold Vault
      ...
      <div>
        ...
        <h2 className="signIn-title-admin">Admin SignIn Page</h2>
          ...
          <div className="input-div-admin">
            ...
            {errors.email && touched.email ? (
              ...
              <div className="input-div-admin">
                <label className="textlabel" for="password">Password</label>
              <input
        ...
        <div>
          <p
            className="forget-password-signin-admin"
